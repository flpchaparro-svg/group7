      ...
      <section className="w-full max-w-[1400px] mx-auto px-4 py-24 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="premium-hover-card p-8 flex flex-col h-full group">
            ...
            <Link href="/services" className="group inline-flex items-center gap-2 font-mono text-xs font-bold text-blue-500 uppercase tracking-widest transition-colors hover:text-blue-400">
            ...
            <div className="absolute inset-0 bg-gradient-to-t from-[#0f172a] via-transparent to-transparent z-20"></div>
              ...
              <div className="absolute top-[0] right-0 bottom-0 left-0 z-20">
                <div className="absolute top-[65%] left-[25%] -translate-x-1/2 -translate-y-1/2 flex flex-col items-center group-hover:scale-110 transition-transform duration-500 cursor-pointer z-10">
                  ...
                  <div className="mt-2 opacity-0 group-hover:opacity-100 transition-opacity duration-300 px-2 py-1 bg-slate-900/90 border border-blue-500/30 rounded text-[9px] font-bold text-white tracking-wide backdrop-blur-md whitespace-nowrap font-mono-sys">
                    WESTERN SYDNEY
                  </div>
                </div>
                ...
                <div className="absolute top-[48%] left-[65%] -translate-x-1/2 -translate-y-1/2 flex flex-col items-center group-hover:scale-110 transition-transform duration-500 delay-75 cursor-pointer z-10">
                  <div className="relative flex items-center justify-center">
                    <div className="w-2.5 h-2.5 bg-red-500 rounded-full shadow-[0_0_15px_rgba(239,68,68,1)] z-10"></div>
                    <div className="absolute w-8 h-8 bg-red-500/20 rounded-full animate-ping delay-700"></div>
                  </div>
                  <div className="mt-2 opacity-0 group-hover:opacity-100 transition-opacity duration-300 px-2 py-1 bg-slate-900/90 border border-blue-500/30 rounded text-[9px] font-bold text-white tracking-wide backdrop-blur-md whitespace-nowrap font-mono-sys">
                    NORTH SHORE
                  </div>
                ...
                <div className="absolute top-[82%] left-[40%] -translate-x-1/2 -translate-y-1/2 flex flex-col items-center group-hover:scale-110 transition-transform duration-500 delay-100 cursor-pointer z-10">
                  <div className="relative flex items-center justify-center">
                    <div className="w-2.5 h-2.5 bg-red-500 rounded-full shadow-[0_0_15px_rgba(239,68,68,1)] z-10"></div>
